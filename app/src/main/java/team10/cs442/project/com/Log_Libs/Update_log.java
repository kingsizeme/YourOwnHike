...
public class Update_log extends AppCompatActivity {
    Databasehelper myDb;
    ListView listView;
    UpdateListDataAdapter listadapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.delete_log);
        listView = (ListView)findViewById(R.id.listView);
        listadapter = new UpdateListDataAdapter(getApplicationContext(),R.layout.raw_layout);
